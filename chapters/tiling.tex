...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=\linewidth]{images/globe1.pdf} %\todo{recolour}
    \end{center}
...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=\linewidth]{images/globe2.pdf} %\todo{recolour}
    \end{center}
...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=\linewidth]{images/globe3.pdf} %\todo{recolour}
    \end{center}
...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=\linewidth]{images/globe4.pdf} %\todo{recolour}
    \end{center}
...
\begin{figure}[p]
    \begin{minipage}[c]{0.46\textwidth}
        \includegraphics[width=\linewidth]{images/algo_product.pdf} %\todo{recolour}??
    \end{minipage}
    \hfill
...
\begin{figure}[p]
    ...
    \hfill
    \begin{minipage}[c]{0.46\textwidth}
        \includegraphics[width=\linewidth]{images/algo_cosine.pdf} %\todo{recolour}??
    \end{minipage}
\end{figure}

\begin{figure}[p]
    \begin{minipage}[c]{0.46\textwidth}
        \includegraphics[width=\linewidth]{images/algo_minverlap.pdf} %\todo{recolour}??
    \end{minipage}
    \hfill
    \begin{minipage}[c]{0.50\textwidth}
...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=\linewidth]{images/spacing_cosine.pdf} %\todo{recolour}
    \end{center}
...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=\linewidth]{images/spacing_minverlap.pdf} %\todo{recolour}
    \end{center}
...
\begin{figure}[p]
    \begin{center}
        \begin{tabular}{cccccc} %\todo{recolour}
