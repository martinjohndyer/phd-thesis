...
As described in \aref{sec:followup}, telescopes with small fields of view can focus on observing possible host galaxies instead of covering an entire GW probability region \citep{GW_weighting}. The most recent catalogue of potential host galaxies is the \acro{glade} catalogue \citep{GLADE}, which combines multiple prior catalogues including the Gravitational Wave Galaxy Catalogue \citep[GWGC,][]{GWGC} used by Swope to successfully find the GW170817 counterpart.
