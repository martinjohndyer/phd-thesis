...
\begin{itemize}
    ...
    \item In \nref{sec:software_commissioning} I describe how the control software was developed along side the hardware, including creating nightly observing routines and how challenges arising from hardware issues were overcome.
\end{itemize}
%
