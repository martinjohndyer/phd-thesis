...
\begin{figure}[p]
    \begin{center}
        ...
        \end{minipage}
    \end{center}
    \caption[Photon transfer curve plots for all 8 cameras]{
        Photon transfer curve plots for all 8 cameras.
        }\label{fig:ptcs}
\end{figure}
...
\begin{figure}[p]
    \begin{center}
        ...
        \end{minipage}
    \end{center}
    \caption[Dark current plots for all 8 cameras]{
        Dark current plots for all 8 cameras.
        }\label{fig:dcs}
\end{figure}
...
\begin{table}[t]
    ...
    \end{center}
    \caption[TODO]{
        Mean deviation from linearity for each camera.
        }\label{tab:lin}
\end{table}
...
\begin{figure}[p]
    \begin{center}
        ...
        \end{minipage}
    \end{center}
    \caption[Linearity plots for all 8 cameras]{
        Linearity plots for all 8 cameras.
        }\label{fig:lin}
\end{figure}
