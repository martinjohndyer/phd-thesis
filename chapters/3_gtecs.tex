...
\begin{mysection}{Introduction}{sec:gtecs_intro}
...
\begin{mysubsection}{Requirements of the control system}{sec:control_desision}
...
\begin{mysubsection}{pt5m}{sec:pt5m}
...
\begin{mysection}{Overview of G-TeCS}{sec:gtecs}
...
\begin{mysubsection}{Daemons}{sec:daemons}
...
\begin{mysubsection}{Scripts}{sec:scripts}
...
\begin{mysection}{Hardware Control}{sec:hardware_control}
...
\begin{mysubsection}{Cameras / Focusers / Filter Wheels}{sec:fli}
...
\begin{mysubsection}{Dome}{sec:dome}
...
\begin{mysubsection}{Power}{sec:power}
...
\begin{mysubsection}{Mount}{sec:mount}
...
\begin{mysection}{Autonomous Observing}{sec:autonomous}
...
\begin{mysubsection}{Pilot}{sec:pilot}
...
\begin{mysubsection}{Hardware monitors}{sec:monitors}
...
\begin{mysubsection}{Conditions}{sec:conditions}
...
\begin{mysubsection}{Observation database}{sec:obsdb}
...
\begin{mysubsection}{Scheduler}{sec:scheduler}
...
\begin{mysubsection}{Sentinel}{sec:sentinel}
