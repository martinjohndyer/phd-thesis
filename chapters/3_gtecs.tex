...
\label{sec:dome}
% astrohaven hardware
% software based on SLODAR/pt5m
%   but they made their own PLC
% sends commands to the PLC as bytes
% timing
%   stutter south side
% repeated commands ("close" overwrites opening, but not closing)
