...
By observing sources with known catalogue magnitudes, and measuring the number of counts from each source in the output image, the zeropoint can be calculated as
%
\begin{equation}
    \begin{split}
