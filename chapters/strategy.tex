...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.75\linewidth]{images/healpix.pdf}
\end{center}
...
HEALPix is used to provide localisation of sky probabilities for transient astronomical events, in the form of sky maps. Each point on the HEALPix grid is assigned a probability between 0 and 1 that the counterpart object is located within that pixel, and the whole sphere should sum to unity.


\begin{figure}[t]
\begin{center}
\includegraphics[width=0.75\linewidth]{images/skymap_plot.pdf}
\end{center}
\caption[An example skymap]{An example skymap.
}
