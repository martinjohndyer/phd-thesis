...
\rtxt{rewrite so it's an independent introduction}
\rtxt{link to future of G-TeCS?}
...
\rtxt{link to scheduler section}
...
\rtxt{link to scheduler chapter, maybe even move there?}
