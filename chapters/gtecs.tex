...
\begin{itemize}
    ...
    \item \code{humidity} and \code{dew\_point}: The critical humidity limit is 75\%, with a bad delay of two minutes and a good delay of ten minutes. The dew point is a linked measurement, with a limit of \SI{4}{\celsius} above the ambient external temperature.
...
\begin{table}[t]
    \begin{center}
        \begin{tabular}{c|l|crc|ccc} % chktex 44
