...
%
\begin{itemize}
    \item In \nref{sec:control_systems} I detail the requirements for the GOTO control system, describe the options considered and detail the chosen system that the future work is built off of.
...
\newpage
\section{Telescope control systems}
...
\todo{Needs rewriting, scripts moved to \aref{chap:autonomous}}
...
\todo{Could be its own section? Or part of hardware control?}
